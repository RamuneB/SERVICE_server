...
import { Types } from 'mongoose'; // Importuojame Mongoose tipą
...
router.post('/login', async (req, res) => {
  try {
    ...
    // Nurodome, kad _id turi būti teisingo tipo (ObjectId)
    const token = generateToken(user._id as Types.ObjectId); // Čia konvertuojame į ObjectId, jei reikia
